...
function addVideo(video) {
    ...
    newDiv.innerHTML = `
        <span class="thumb"><span class="wpvid" class="center-poster"><video poster="${thumbSrc}" class="vidplay" name="media" id="videoPlayer" controlsList="nodownload">
...
const videoToDisplay = [videoList[31]];
