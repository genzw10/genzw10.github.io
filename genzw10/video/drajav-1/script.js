...
function addVideo(video) {
    ...
    newDiv.innerHTML = `
        <span class="thumb"><span class="center-poster"><iframe class="thumb" width="600" height="auto" src="${vidSrc}" scrolling="no" frameborder="0" allowfullscreen="true"></iframe></span>
